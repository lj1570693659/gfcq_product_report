  ...
  <div class="app-container">
    ...
    >
      ...
      >
        ...
        <el-form-item label="分配比例" prop="quotaRadio">
          <el-input
...
import { getAll, createData, modifyData, deleteData } from '@/api/config/inspirit/radio'
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        quotaRadio: [{ validator: validateRadioRequire }],
